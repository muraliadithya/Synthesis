...
(and (= r labelOf) (= a s3_o1) (= b cat))
(and (= r labelOf) (= a s3_o2) (= b sofa))
(and (= r labelOf) (= a s3_o2) (= b cat))
(and (= r labelOf) (= a s2_o2) (= b sofa))
...
(and (= r labelOf) (= a s4_o1) (= b chair))
(and (= r labelOf) (= a s4_o1) (= b cat))
(and (= r labelOf) (= a s4_o1) (= b cat))
(and (= r labelOf) (= a s4_o2) (= b chair))
(and (= r labelOf) (= a s4_o2) (= b sofa))
(and (= r labelOf) (= a s4_o2) (= b chair))
(and (= r labelOf) (= a s4_o2) (= b cat))
(and (= r labelOf) (= a s4_o2) (= b cat))
(and (= r labelOf) (= a s4_o3) (= b chair))
(and (= r labelOf) (= a s4_o3) (= b sofa))
(and (= r labelOf) (= a s4_o3) (= b chair))
(and (= r labelOf) (= a s4_o3) (= b cat))
(and (= r labelOf) (= a s4_o3) (= b cat))
(and (= r labelOf) (= a s4_o4) (= b chair))
(and (= r labelOf) (= a s4_o4) (= b sofa))
(and (= r labelOf) (= a s4_o4) (= b chair))
(and (= r labelOf) (= a s4_o4) (= b cat))
(and (= r labelOf) (= a s4_o4) (= b cat))
(and (= r labelOf) (= a t2_o1) (= b sofa))
(and (= r labelOf) (= a t2_o1) (= b cat))
(and (= r labelOf) (= a t2_o1) (= b cat))
...
(and (= r labelOf) (= a t3_o1) (= b cat))
(and (= r labelOf) (= a t3_o1) (= b cat))
(and (= r labelOf) (= a t1_o1) (= b sofa))
(and (= r labelOf) (= a t1_o1) (= b cat))
(and (= r labelOf) (= a t1_o1) (= b cat))
(and (= r labelOf) (= a t1_o2) (= b sofa))
(and (= r labelOf) (= a t1_o2) (= b cat))
(and (= r labelOf) (= a t1_o2) (= b cat))
(and (= r labelOf) (= a t1_o3) (= b sofa))
...
;bindings for extraneous objects
 bind_nullobj bind_sofa bind_chair bind_cat
)))
